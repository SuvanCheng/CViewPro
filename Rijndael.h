...
public:
	...
	long GetPaddingEncLen(long n);
	void PaddingEncrypt(char const* in, char* result, size_t n, int iMode=ECB);

	void Decrypt(char const* in, char* result, size_t n, int iMode=ECB);
	long PaddingDecrypt(char const* in, char* result, size_t n, int iMode=ECB);
