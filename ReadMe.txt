========================================================================
		ActiveX Control DLL : CVIEWPRO
========================================================================

ControlWizard has created this project for your CVIEWPRO ActiveX Control
...
that make up your CVIEWPRO ActiveX Control DLL.
...
CViewProCtl.h
	This file contains the declaration of the CCViewProCtrl C++ class.

CViewProCtl.cpp
	This file contains the implementation of the CCViewProCtrl C++ class.

CViewProPpg.h
	This file contains the declaration of the CCViewProPropPage C++ class.

CViewProPpg.cpp
	This file contains the implementation of the CCViewProPropPage C++ class.

CViewProCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCViewProCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CViewPro.rc.
